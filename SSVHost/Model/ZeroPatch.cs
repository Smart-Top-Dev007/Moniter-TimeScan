                ...
                try
                {
                    ...
                    try
                    {
                                ...
                                if (recvData > 0)
                                {
                                    ...
                                    if (prefix == Constants.Se_Version)
                                    {
                                        ...
                                        if (rk == null || rk.GetValue("Version").ToString() != new_version)
                                        {
                                            ...
                                            if (File.Exists(Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\ServerSetup.exe"))
                                            {
                                                try
                                                {
                                                    File.Delete(Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\ServerSetup.exe");
                                                }
                                                catch
                                                {
                        ...
                        if(bRun == true)
                        {
                            ...
                            try
                            {
                                process.StartInfo.FileName = Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\ServerSetup.exe";
