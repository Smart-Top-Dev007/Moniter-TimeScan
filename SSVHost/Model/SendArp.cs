...
namespace SSVHost.Model
{
    ...
    public class SendArp
    {
        ...
        private void Sending()
        {
            ...
            string str_ArpInfo = ipFinder.FindIpAddressByMacAddress();
            ...
            try
            {
                ...
                string arpData = $"{ipAddress}*server*{strSysCreated}&{str_ArpInfo}";
                using (StreamWriter sw = File.AppendText("Log_Server11111111111.txt"))
                {
                    sw.WriteLine(arpData + "---" + DateTime.Now.ToString());
                }
                //string arpData = $"{ipAddress}*server*{strSysCreated}";
        ...
        public string getSystemInstalledDate()
        {
            ...
            if (key != null)
            {
                ...
                return installDate.ToString("MM/dd/yyyy HH:mm:ss");
            }
            return DateTime.MinValue.ToString("MM/dd/yyyy HH:mm:ss");
        }
