...
namespace PatchService.Globals
{
    ...
    {
        internal static readonly string ClientPath = "Patch\\Client";
        internal static readonly string ServerPath = "Patch\\Server";
        internal static readonly string PatchPath = "Patch\\";


        internal static readonly string TitleVersion = "Patch Server 2.5";  
        ...
        internal static readonly string LoaderMainLogFileName = "PatchService.Log.txt";
        //Network protocols
        ...
        internal static readonly double ArpDifferMin = 1440.0;
        internal static readonly double ArpRealMin = 30.0;
