                        ...
                        while (true)
                        {
                            try
                            {
                                ...
                                if (recvData > 0)
                                {
                                    ...
                                    string path = Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\";
                                    ...
                                    if (prefix == Constants.Se_Version)
                                    {
                                        ...
                                        if (rk == null || rk.GetValue("Version").ToString() != new_version)
                                        {
                                            ...
                                            if (File.Exists(Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\CMonAutoSetup.exe"))
                                            {
                                                try
                                                {
                                                    File.Delete(Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\CMonAutoSetup.exe");
                                                }
                                                catch
                                                {
                                            ...
                                            if (File.Exists(Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\ClientSetup.exe"))
                                            {
                                                try
                                                {
                                                    File.Delete(Path.GetPathRoot(Environment.SystemDirectory)+"Users\\Public\\ClientSetup.exe");
                                                }
                                                catch
                                                {
