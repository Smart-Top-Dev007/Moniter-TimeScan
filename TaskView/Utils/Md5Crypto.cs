...
namespace Monitor.TaskView.Utils
{
    public static class Md5Crypto
    {
        ...
        //public static Image ReadImageFile(string strPath, string fileName)
        //{
        //    Image imgTemp;
        //    string strFileNameTemp = "";
        //    for (int i = 0; i < fileName.Length; i++)
        //    {
        //        if ((int)fileName[i] - '0' >= 0 && (int)fileName[i] - '0' < 10)
        //        {
        //            strFileNameTemp = strFileNameTemp.Insert(i, Constants.strArray[(int)fileName[i] - '0']);
        //        }
        //        else
        //        {
        ...
        //public static Dictionary<string, Image> ReadAllImageFile(string strPath)
        //{
