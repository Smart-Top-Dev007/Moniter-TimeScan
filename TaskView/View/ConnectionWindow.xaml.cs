...
namespace Monitor.TaskView.View
{
    ...
    {
        public delegate void ConnectionWindowDelegate(ConnectionWindow ui, Dictionary<string, object> args);
        ...
        public ConnectionWindowDelegate[] Routines { get; private set; }
        ...
        public int OveralMaxProgress
        {
            ...
            set
            {
                ...
                OveralStatusProgressBar.Dispatcher.Invoke(() => { OveralStatusProgressBar.Maximum = value; });
        ...
        public int OveralCurrentProgress
        {
            ...
            set
            {
                ...
                OveralStatusProgressBar.Dispatcher.Invoke(() => { OveralStatusProgressBar.Value = value; });
        ...
        public void BeginConnect(ConnectionWindowDelegate[] routines, Dictionary<string, object> args)
        {
            if (_t != null)
            {
                return;
        ...
        private void DoWork(object args)
        {
            for (var i = 0; i < Routines.Length; i++)
            {
                ...
                {
                    CustomMsg message = new CustomMsg(string.Format(
                            "Unexpected error during update routine! \n\n Routine: \"{0}\",\n Exception: {1}",
                            Routines[i].Method.Name, ex));
                    //MessageBox.Show(
                    //    string.Format(
                    //        "Unexpected error during update routine! \n\n Routine: \"{0}\",\n Exception: {1}",
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            if (!AllowExit)
            {
                var result =
                    MessageBox.Show(
                        "TaskView connection wizard is currently busy. It is recommended that you wait to finish. Do you really want to exit?",
                        "TaskView Connection Wizard", MessageBoxButton.YesNo, MessageBoxImage.Exclamation);
