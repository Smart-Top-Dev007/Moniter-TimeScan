    ...
    public class URLProc
    {
        ...
        public void RecvURLInfo(byte[] buf, string clientIP)
        {
            ...
            if (strlist.Length == 5)
            {
                ...
                Settings.Instance.ClientDic[clientIP].DangerURLCount = strlist[4];
                Md5Crypto.WriteCryptoFileAppend(Settings.Instance.Directories.TodayDirectory + "\\" + clientIP, Constants.DangerURLName, strlist[4]);
            }
