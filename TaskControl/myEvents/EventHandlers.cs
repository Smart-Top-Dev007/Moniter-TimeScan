...
namespace Monitor.TaskControl.myEvents
{
    class EventHandlers
    {
        ...
        {
            //Settings.Instance.ClientDic_Temp = new Dictionary<string, ClientInfo>();
            ...
            else
            {
                ...
                Log.Instance.DoLog("-------- After MainWindow ----", Log.LogType.Info);
                Windows.MainWindow.Show();
                Log.Instance.DoLog("-------- Main Window SHOW ----", Log.LogType.Info);
                Communications.StartUpSocket();
                Log.Instance.DoLog("-------- StartUp Socket ----", Log.LogType.Info);
            }
